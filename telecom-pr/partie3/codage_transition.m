...
hold on;
semilogy(0:0.5:6,2*TEB_theorique_40_avec,'g');
hold on;
semilogy(0:0.5:6,TEB_pratique_40_sans);
hold on;
semilogy(0:0.5:6,2*TEB_theorique_40_sans);
hold on;
...
title("Comparaison des TEB avec correction et sans correction d'erreur de phase/ avec et sans codage ( phi = 40° )")
...
hold on;
semilogy(0:0.5:6,2*TEB_theorique_100_avec,'g');
hold on;
semilogy(0:0.5:6,TEB_pratique_100_sans);
hold on;
semilogy(0:0.5:6,2*TEB_theorique_100_sans);
hold on;
semilogy(0:0.5:6,TEB_p_100_avec_correction,'r');
hold on;
semilogy(0:0.5:6,TEB_t_100_avec_correction,'r');
hold off
xlabel("E_b/N_0")
ylabel("TEB")
legend("TEB_{pratique/avec codage/avec correction}","TEB_{theorique/avec codage/avec correction}","TEB_{pratique/avec codage/sans correction}","TEB_{theorique/avec codage/sans correction}","TEB_{pratique/sans codage/avec correction}","TEB_{theorique/sans codage/avec correction}")
title("Comparaison des TEB avec correction et sans correction d'erreur de phase/ avec et sans codage ( phi = 100° )")
