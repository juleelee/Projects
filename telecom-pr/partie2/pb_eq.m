...
%% 3. Implantation de chaine passe-bas  ́equivalente `a la chaine de transmission sur porteuse
clear all 
close all
...
save('TEB_DVB_S.mat', 'TEB_pratique')
...
for db = 0:0.5:6
    ...
    % Calcul du TEB
    TEB_bis = TES_bis / log2(M);
    TEB_pratique1 = [TEB_pratique1 TEB_bis];
   

end 

figure(19)
semilogy(0:0.5:6,TEB_pratique1);
hold on;
semilogy(0:0.5:6,TEB_pratique,'g');
hold off
xlabel("E_b/N_0")
ylabel("TEB")
legend("TEB_{freq proteuse}","TEB_{passe bas eq}")
title("Comparaison des TEB : transmis sur freq porteuse et passe bas eq")
